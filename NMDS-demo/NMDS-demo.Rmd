...
This stage of the script uses the [vegan] package to process the biovolume data in order to generate the NMDS plots. It saves the stress of each configuration to a .CSV file. 

```{r process data, message=FALSE, fig.show='hide'}
...
for (i in 1:length(years)) {
  ...
  capture.output(phyto.NMDS <- metaMDS(comm = genw[c(7:139)],
                        distance = "bray",
                        k = 3,
                        trymax = 500,
                        wascores=FALSE
